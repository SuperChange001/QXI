set_property -dict { PACKAGE_PIN H11   IOSTANDARD LVCMOS33 } [get_ports { sys_clk }]; # IO_L13P_T2_MRCC_14
create_clock -add -name clk_100 -period 10.00 -waveform {0 5} [get_ports { sys_clk }];
