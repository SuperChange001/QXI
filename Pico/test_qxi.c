// This program only works with the logic design without middleware
#include "pico/stdlib.h"
#include <stdio.h>
#include "hardware/spi.h"
#include <stdlib.h>
#include <stdbool.h>
#include "middleware/qxi.h"
    ...
    while(1)
    {
        ...
        else if (c =='w')
        {
            ...
            for (int k=0; k<100; k++)
            {
                ...
                qxi_write_blocking(0x0000, dat_sent, 14);

                qxi_read_blocking(0x0000, dat_recv, 14);
                bool err_flag = false;
                for(int i=0;i<14;i++)
                {
